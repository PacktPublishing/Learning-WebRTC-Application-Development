...
public class DataServlet extends HttpServlet {
	...
	private static final Logger logging = Logger.getLogger(DataServlet.class.getName());
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (room_key == null){
			...
			redirect=getBaseUrl(req)+"data?r="+room_key;
		...
		String room_link= getBaseUrl(req)+"data?r="+room_key;
		...
		String indexhtml=(readFile("template_data.html")); // 0.html
